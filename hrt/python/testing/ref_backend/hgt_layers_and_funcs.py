...
def ref_hgt_full_graph_hetero_attention_ops_coo(*args):
    raise NotImplementedError(
        "ref_hgt_full_graph_hetero_attention_ops_cooc requires Ref classes be"
...
def ref_hgt_full_graph_message_calc_edge_softmax_and_message_mean_aggregation_csr(
    *args,
    ...
    raise NotImplementedError(
        "ref_hgt_full_graph_message_calc_edge_softmax_and_message_mean_aggregation_csr"
...
def ref_hgt_full_graph_edge_softmax_and_message_mean_aggregation_csr(*args):
    raise NotImplementedError(
        "ref_hgt_full_graph_edge_softmax_and_message_mean_aggregation_csr"
        " requires Ref classes be subclasses of torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
        ...
        debug=True,
    )(backend.hgt_full_graph_edge_softmax_and_message_mean_aggregation_csr)(
        *args
    )
