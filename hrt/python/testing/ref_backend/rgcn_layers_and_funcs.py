...
def ref_rgcn_layer1_separate_coo(*args):
    raise NotImplementedError(
        "ref_rgcn_layer1_separate_coo requires Ref classes be subclasses of"
        " torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
        RgcnLayer1SeparateCoo=RefRgcnLayer1SeparateCoo,
        debug=True,
...
def ref_rgcn_node_mean_aggregation_compact_as_of_node_separate_coo(*args):
    raise NotImplementedError(
        "ref_rgcn_node_mean_aggregation_compact_as_of_node_separate_coo"
    ...
    )(backend.rgcn_node_mean_aggregation_compact_as_of_node_separate_coo)(
        *args
    )


def ref_rgcn_node_mean_aggregation_compact_as_of_node_separate_coo_single_sided(
    *args,
):
    raise NotImplementedError(
        "ref_rgcn_node_mean_aggregation_compact_as_of_node_separate_coo_single_sided"
        " requires Ref classes be subclasses of torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
