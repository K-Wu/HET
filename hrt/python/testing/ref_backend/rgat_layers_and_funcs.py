...
def ref_relational_fused_gat_csr(*args):
    raise NotImplementedError(
        "ref_relational_fused_gat_csr requires Ref classes be subclasses of"
        " torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
        debug=True,
        RelationalFusedGatCSR=RefRelationalFusedGatCSR,
...
def ref_relational_fused_gat_compact_as_of_node_separate_coo_dual_unique_node_list(
    *args,
    ...
    raise NotImplementedError(
        "relational_fused_gat_compact_as_of_node_separate_coo_dual_unique_node_list"
        " requires Ref classes be subclasses of torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
        debug=True,
...
def ref_relational_fused_gat_separate_coo(*args):
    raise NotImplementedError(
        "relational_fused_gat_separate_coo requires Ref classes be subclasses"
...
def ref_relational_fused_gat_compact_as_of_node(*args):
    raise NotImplementedError(
        "ref_relational_fused_gat_compact_as_of_node requires Ref classes be"
...
def ref_relational_fused_gat_compact_as_of_node_separate_coo(*args):
    raise NotImplementedError(
        "ref_relational_fused_gat_compact_as_of_node_separate_coo requires Ref"
...
def ref_relational_fused_gat_compact_as_of_node_separate_coo_single_sided(
    *args,
):
    raise NotImplementedError(
        "ref_relational_fused_gat_compact_as_of_node_separate_coo_single_sided"
        " requires Ref classes be subclasses of torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
        ...
        backend.relational_fused_gat_compact_as_of_node_separate_coo_single_sided
    )(
        *args
    )
