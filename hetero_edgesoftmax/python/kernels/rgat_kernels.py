...
def rgat_relational_matmul_ac_gather_scatter_list_identical(*args):
    return torch.ops.torch_hetero_edgesoftmax.rgat_relational_matmul_ac_gather_scatter_list_identical(
        *args
    )


def rgat_relational_matmul_backward_ac_gather_scatter_list_identical(*args):
    return torch.ops.torch_hetero_edgesoftmax.rgat_relational_matmul_backward_ac_gather_scatter_list_identical(
        *args
    )
