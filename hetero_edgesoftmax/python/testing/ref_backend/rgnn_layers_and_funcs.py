...
def ref_rgnn_relational_matmul(*args):
    raise NotImplementedError(
        "ref_rgnn_relational_matmul requires Ref classes be subclasses of torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite, RgnnRelationalMatmul=RefRgnnRelationalMatmul, debug=True
...
def ref_rgnn_relational_matmul_no_scatter_gather_list(*args):
    raise NotImplementedError(
        "ref_rgnn_relational_matmul_no_scatter_gather_list requires Ref classes be subclasses of torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
...
def ref_rgnn_relational_matmul_compact_as_of_node(*args):
    raise NotImplementedError(
        "ref_rgnn_relational_matmul_compact_as_of_node requires Ref classes be subclasses of torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
...
def ref_rgnn_inner_product_node_compact_and_node(*args):
    raise NotImplementedError(
        "ref_rgnn_inner_product_node_compact_and_node requires Ref classes be subclasses of torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
...
def ref_rgnn_inner_product_edge_and_node(*args):
    raise NotImplementedError(
        "ref_rgnn_inner_product_edge_and_node requires Ref classes be subclasses of torch.autograd.Function"
    )
    return utils_lite.reroute_namespace(
        K=ref_kernels_lite,
