if __name__ == "__main__":
    ...
    from .nsight_utils.upload_benchmark_results import ask_subdirectory_or_file
    from .nsight_utils.load_nsight_report import upload_nsys_report
    ...
    path_name = ask_subdirectory_or_file(
        "misc/artifacts", "motivator_graphiler_breakdown_", RESULTS_RELATIVE_DIR
    )
    upload_nsys_report(
        path_name,
        "cuda_kern_exec_sum",
