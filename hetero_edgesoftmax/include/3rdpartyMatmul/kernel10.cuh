#pragma once
// from https://github.com/yzhaiustc/Optimizing-SGEMM-on-NVIDIA-Turing-GPUs/blob/main/include/kernel10.cuh
// A, B, and C are all column-major. 
// TODO: transposition needed but for performance test, we may ignore transposition and use the original raw data region anyway
// TODO: padding needed as vectorized load/store does not consider cases if the matrix #rows/cols is not multiple of vector length
