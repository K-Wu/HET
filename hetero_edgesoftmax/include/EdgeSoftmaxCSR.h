...
__device__ __forceinline__ void _perRow_EdgeSoftmaxFirstStageConcatenatedCSRKernel(int row_idx, float **__restrict__ outNodes_per_relation, int num_rows, int nnz, int *__restrict__ matCols, int *__restrict__ matRows, int *__restrict__ relation,
...
__device__ __forceinline__ void _perRow_EdgeSoftmaxSecondStageConcatenatedCSRKernel(int row_idx, float *__restrict__ outEdge, float **__restrict__ outNodes_per_relation, int num_rows, int nnz, int *__restrict__ matCols, int *__restrict__ matRows,
...
__device__ __forceinline__ void _EdgeSoftmaxFirstStageConcatenatedCSRKernel(int beg_row_idx, int stride, float **__restrict__ outNodes_per_relation, int num_rows, int nnz, int *__restrict__ matCols, int *__restrict__ matRows, int *__restrict__ matRelation,
                                                                            float *__restrict__ edge_input_data, float *__restrict__ mus)
{
...
__device__ __forceinline__ void _EdgeSoftmaxSecondStageConcatenatedCSRKernel(int beg_row_idx, int stride, float *__restrict__ outEdge, float **__restrict__ outNodes_per_relation, int num_rows, int nnz, int *__restrict__ matCols, int *__restrict__ matRows, int *__restrict__ matRelation,
                                                                             float *__restrict__ edge_input_data, float *__restrict__ mus)
{
    for (int row_idx = beg_row_idx; row_idx < num_rows; row_idx += stride)
    {
...
std::vector<thrust::device_vector<float>> doGPUEdgeSoftmaxConcatenatedCSRKernel(cusp::csr_matrix<int, int, cusp::device_memory> concatenated_csr_matrix, int num_relations, bool FlagInitWithRandomValue)
{
