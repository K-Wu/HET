...
_perRow_EdgeSoftmax_4FirstStageConcatenatedCSCKernel(
...
__device__ __forceinline__ void
_perRow_EdgeSoftmax_4SecondStageConcatenatedCSCKernel(
...
template <int num_max_relations>
__device__ __forceinline__ void _EdgeSoftmax_4FirstStageConcatenatedCSCKernel(
  ...
  for (int col_idx = beg_col_idx; col_idx < num_cols; col_idx += stride) {
    _perRow_EdgeSoftmax_4FirstStageConcatenatedCSCKernel<num_max_relations>(
        num_relations, col_idx, outNodes_per_relation, num_cols, nnz, matCols,
        matRows, matRelation, edge_input_data, mus);
  }
}

__device__ __forceinline__ void _EdgeSoftmax_4SecondStageConcatenatedCSCKernel(
...
template <int num_max_relations>
__global__ void HET_EdgeSoftmax_4ConcatenatedCSCKernel(
  ...
  _EdgeSoftmax_4FirstStageConcatenatedCSCKernel<num_max_relations>(
...
doGPUEdgeSoftmax_4ConcatenatedCSCKernel(
  ...
  HET_EdgeSoftmax_4ConcatenatedCSCKernel<NUM_MAX_RELATIONS><<<grid, block>>>(
  ...
  std::chrono::high_resolution_clock::time_point t2 =
      std::chrono::high_resolution_clock::now();
  std::cout
      << "GPU doGPUEdgeSoftmax_4ConcatenatedCSCKernel time: "
